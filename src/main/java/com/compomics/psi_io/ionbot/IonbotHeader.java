...
/**
 * This class represents a single header entry of a Ionbot output file.
 * <p>
 * Created by Niels Hulstaert on 13/09/16.
 */
public class IonbotHeader {
     ...
     */
    public IonbotHeader(String name, boolean mandatory, List<String> values) {
        this.name = name;
